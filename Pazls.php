...
<html>
<head>
<title>Пазл. Объекты меценатства</title>
</head>
<h1><center><font color = "green">Соберите пазл одного из объектов меценатства Пензенской области</font></center></h1>
<body>
<div id="menu-top">
<div class="bg-1">
<ul>
<li><a href="gamesHub.php">Другие игры</a></li>
...
if(gameWin)
{
    document.location.href = "PazlsWin.php";
...
.bg-1 {width:950px; height:64px; background:green url(images/m1.png) repeat-x; padding:0 0 0 10px;}
